    ...
    public function getInsuranceInfo($insurance_name)
    {
        return match ($insurance_name) {
            'Maxima' => implode("\n", [
                ...
                "— возможно оформить тариф Exclusive с надстандартным пакетом MaxCare на сумму 4.000 крон (очки, линзы, необязательная вакцинация, слуховой аппарат, свободно доступные лекарства и медицинские препараты, приобретенные в аптеках (без рецепта).",
            ]),
            'pVZP' => implode("\n", [
                "*pVZP*"."\n",
